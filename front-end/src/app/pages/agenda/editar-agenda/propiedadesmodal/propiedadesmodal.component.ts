...
@Component({
  selector: 'app-propiedadesmodal',
  templateUrl: './propiedadesmodal.component.html',
  styleUrls: ['./propiedadesmodal.component.scss']
})
export class PropiedadesModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<PropiedadesModalComponent>,
